              ...
              <Card className="form-card border-0 shadow-sm">
                <CardBody className="p-4">
                  ...
                  <p className="text-muted mb-4">
                    Isi form di bawah ini, saya akan merespon secepatnyaa!
                  </p>
                  <Form>
                    <Row>
                      <Col md={6}>
                    ...
                    <Button
                      style={{ backgroundColor: "#da3394 " }}
                      className="w-100 btn-send py-2"
                    >
          ...
          <div className="mt-5">
            ...
            <Row className="g-3">
              ...
              <SocialCard
                ...
                name="YouTube"
                username="Santain aja channel"
              />
              <SocialCard
                icon={<Linkedin color="#0A66C2" />}
                name="LinkedIn"
                username="Beli Dermawan"
              />
              <SocialCard
