...
// } from "lucide-react"; // Gunakan lucide-react atau font-awesome
// import "./Contact.css";
...
//         <Container>
//           <div className="badge-collab mb-3">
...
//                   icon={<Mail />} 
//                   title="Email" 
//                   detail="banyubanyuganesha@gmail.com" 
//                   linkText="Kirim Pesan →" 
//                 />
//                 <ContactInfoCard 
//                   icon={<Phone />} 
//                   title="Telepon / WhatsApp" 
//                   detail="+62 812 2707 7896" 
...
//                     </FormGroup>
//                     <Button color="primary" className="w-100 btn-send py-2">
...
//             <Row className="g-3">
//                <SocialCard icon={<Instagram color="#E4405F"/>} name="Instagram" username="@b4n.yuu" />
//                <SocialCard icon={<Youtube color="#FF0000"/>} name="YouTube" username="Banyu Ganesha" />
//                <SocialCard icon={<Linkedin color="#0A66C2"/>} name="LinkedIn" username="Banyu Ganesha" />
//                <SocialCard icon={<Github color="#333"/>} name="GitHub" username="Banyunyu" />
//             </Row>
//           </div>
//         </Container>
//       </section>
